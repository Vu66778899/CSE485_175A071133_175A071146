...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
             ...
             <li class="treeview">
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="them_baiviet.php"><i class="fa fa-angle-right"></i> Thêm bài viết</a></li>
                  <li><a href="so_baiviet.php"><i class="fa fa-angle-right"></i> Sửa và xóa bài viết</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  <li><a href=""><i class="fa fa-angle-right"></i> Người dùng</a></li>
                </ul>
              </li>
			  <li>
                <a href="widgets.html">
					...
					<ul>
						<li class="dropdown profile_details_drop">
							...
							<ul class="dropdown-menu drp-mnu">
								...
								<li> <a href="../dangnhap.php"><i class="fa fa-sign-out"></i> Logout</a> </li>
							</ul>
						</li>
					</ul>
				</div>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1">Quản Lý Bài Viết</h2>
				<div class="grids widget-shadow">
					<?php include('../posts/thembaiviet.php'); ?>
			</div>
		</div>
		<!--footer-->
		<div class="footer">
